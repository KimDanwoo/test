window.onload = function () {
  $(() => {
    ...
    $(document).on('click', '#myonoffswitch02', function () {
      if (this.checked) {
        ...
        $('.main-menu').removeClass(
          'main-sidebar main-sidebar-sticky side-menu'
        )
    ...
    $(document).on('click', '#myonoffswitch03', function () {
      if (this.checked) {
        ...
        if (
          document
            .querySelector('.page')
            .classList.contains('main-signin-wrapper') !== true
        ) {
          checkHoriMenu()
          HorizontalHovermenu()
        }
    ...
    $(() => {
      const bodyhorizontal = $('body').hasClass('horizontalmenu')
      if (bodyhorizontal) {
        if (window.innerWidth >= 992) {
          const subNavSub = document.querySelectorAll('.sub-nav-sub')
          subNavSub.forEach((e) => {
    ...
    $(document).on('click', '#myonoffswitch20', function () {
      if (this.checked) {
        ...
        $.each(carousel, (index, element) => {
          // element == this
          const carouselData = $(element).data('owl.carousel')
  ...
  $(function () {
    ...
    $(() => {
      const bodyhorizontal = $('body').hasClass('horizontalmenu-hover')
      if (bodyhorizontal) {
        if (window.innerWidth >= 992) {
          const subNavSub = document.querySelectorAll('.sub-nav-sub')
          subNavSub.forEach((e) => {
    ...
    const bodyclosed = $('body').hasClass('closed-menu')
    if (bodyclosed) {
      $('body').addClass('closed-menu')
      $('body').addClass('main-sidebar-hide')
    }
    ...
    const bodyiconoverlay = $('body').hasClass('icon-overlay')
    if (bodyiconoverlay) {
      $('body').addClass('icon-overlay')
      $('body').addClass('main-sidebar-hide')
    }
    ...
    const bodyicontext = $('body').hasClass('icontext-menu')
    if (bodyicontext) {
      if (
        document
          .querySelector('.page')
    ...
    const bodyhover = $('body').hasClass('hover-submenu')
    if (bodyhover) {
      $('body').addClass('hover-submenu')
      if (
        document
    ...
    /** *************** HOVER-SUBMENU HAs Class ******************** */
    const bodyhover1 = $('body').hasClass('hover-submenu1')
    if (bodyhover1) {
      $('body').addClass('hover-submenu1')
      if (
        document
  ...
  // LTR & RTL
  if (
    !localStorage.getItem('dashplexrtl') &&
    !localStorage.getItem('dashplexltr')
  ) {
    /** *************** RTL ******************** */
    // $('body').addClass('rtl');
    /** *************** RTL ******************** */
  ...
  if (
    !localStorage.getItem('dashplexlight') &&
    !localStorage.getItem('dashplexdark')
  ) {
    /** *************** Light THEME ******************** */
    // $('body').addClass('light-theme');
    /** *************** Light THEME ******************** */
  ...
  if (
    !localStorage.getItem('dashplexvertical') &&
    !localStorage.getItem('dashplexhorizontalmenu') &&
    !localStorage.getItem('dashplexhorizontalmenuHover')
  ) {
    /* Horizontal Menu Start */
    // $('body').addClass('horizontalmenu');
  ...
  // Boxed Layout Style
  if (
    !localStorage.getItem('dashplexfullwidth') &&
    !localStorage.getItem('dashplexboxedwidth')
  ) {
    // $('body').addClass('layout-boxed');
  }
  ...
  if (
    !localStorage.getItem('dashplexfixed') &&
  ...
  // Menu Styles
  if (
    !localStorage.getItem('dashplexlightmenu') &&
    !localStorage.getItem('dashplexcolormenu') &&
    !localStorage.getItem('dashplexdarkmenu') &&
    !localStorage.getItem('dashplexgradientmenu')
  ) {
    /** Light-menu* */
    // $('body').addClass('light-menu');
    // $('body').removeClass('dark-menu');
  ...
  // Header Styles
  if (
    !localStorage.getItem('dashplexlightheader') &&
    !localStorage.getItem('dashplexcolorheader') &&
    !localStorage.getItem('dashplexdarkheader') &&
    !localStorage.getItem('dashplexgradientheader')
  ) {
    /** Light-Header* */
    // $('body').addClass('header-light');
    /** Light-Header* */
